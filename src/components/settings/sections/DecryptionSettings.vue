...
<template>
  <div class="space-y-4">
    ...
    <Card>
      <CardHeader>
        <CardTitle class="text-base">密钥配置</CardTitle>
        <CardDescription>手动添加 DRM 解密密钥 (KID:KEY 格式)</CardDescription>
      </CardHeader>
      <CardContent class="space-y-4">
    ...
    <Card>
      <CardHeader>
        <CardTitle class="text-base">HLS 自定义解密</CardTitle>
        <CardDescription>用于特殊 HLS 加密流的解密配置</CardDescription>
      </CardHeader>
      <CardContent class="space-y-4">
        <SettingSwitch
        ...
        <Separator v-if="customHls.enabled" />
